                      ...
                      <table className="mt-5 table-fixed text-white shadow-lg rounded-lg w-full">
                            <tbody>
                                <tr>
                                    ...
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">FROM USER</th>
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">INV AMOUNT</th>
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">PACKAGE NAME</th>
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">PERCENT</th>
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">PROFIT</th>
