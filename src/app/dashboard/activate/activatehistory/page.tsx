                ...
                <div className="mt-4 w-full">
                  <div className="flex gap-10 justify-between flex-col lg:flex-row">
                    <div className="flex-[4]">
                      ...
                      <br />
                      <table className="mt-3 table-fixed text-white shadow-lg rounded-lg w-full">
                            <tbody>
                                <tr>
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">SR NO</th>
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">SENDER</th>
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">RECIEVER</th>
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">AMOUNT</th>
