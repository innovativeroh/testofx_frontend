                      ...
                      <table className="mt-5 table-fixed text-white shadow-lg rounded-lg w-full ">
                            <tbody>
                                <tr>
                                    ...
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">WITHDRAW AMOUNT</th>
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">PAYABLE AMOUNT</th>
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">SERVICE CHARGE</th>
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">WALLET</th>
                                    <th className=" border-spacing-2 border-white border-2 p-5 text-xl">ADDRESS</th>
